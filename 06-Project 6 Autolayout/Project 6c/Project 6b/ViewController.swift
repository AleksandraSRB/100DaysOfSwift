...
//  Project 6b
//
//  Created by Aleksandra Sobot on 23.10.23..
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for label in labels {
            ...
            if let myView = view {
                myView.heightAnchor.constraint(equalTo: view.safeAreaLayoutGuide.heightAnchor, multiplier: 0.5, constant: 10).isActive = true
            }
